...
#style-8::-webkit-scrollbar-track {
  ...
  <body>
  <button id='home_btn' type="button"><i class="fa fa-eye"></i></button>
  <button id='refresh_btn' type="button"><i class="fa fa-refresh"></i></button>
    <div class="n1">
      <div class="header">    
      </div>
      <div class="container">
	...
	*/
	...
	console.log(123);
	 $(li_data).each(function(idx/*, elem*/) {
		...
		li.append("<a><span class='target-type'>"+this.type+"</span><span class='target-name'>"+this.name+"</span><span class='target-lon'>"+this.lon+"&#176;N</span><span class='target-lat'>"+this.lat+"&#176;E</span></a>");
	});
	initail_clear();
		}).fail(function(jqXHR){
